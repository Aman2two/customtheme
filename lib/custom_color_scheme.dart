...
class MyColorScheme {
  ...
  MyColorScheme(this.colorMap) {
    myColorScheme = ColorScheme(
      brightness: Brightness.light,
      primary: Color(colorMap["primary"] as int? ?? 0xff4496e0),
      onPrimary: Color(colorMap["onPrimary"]as int? ?? 0xffffffff),
      primaryContainer: Color(colorMap["primaryContainer"] as int? ?? 0xffb4e6ff),
      onPrimaryContainer: Color(colorMap["onPrimaryContainer"]as int? ?? 0xff1f2728),
      secondary: Color(colorMap["secondary"]as int? ?? 0xff202b6d),
      onSecondary: Color(colorMap["onSecondary"]as int? ?? 0xffffffff),
      secondaryContainer: Color(colorMap["secondaryContainer"]as int? ?? 0xff99ccf9),
      ...
      tertiaryContainer: Color(colorMap["tertiaryContainer"]as int? ?? 0xffbaa99d),
      onTertiaryContainer: Color(colorMap["onTertiaryContainer"]as int? ?? 0xff201d1b),
      ...
      onErrorContainer: Color(colorMap["onErrorContainer"]as int? ?? 0xff282526),
      ...
      onSurfaceVariant: Color(colorMap["onSurfaceVariant"]as int? ?? 0xff121313),
      inverseSurface: Color(colorMap["inverseSurface"]as int? ?? 0xff131619),
      onInverseSurface: Color(colorMap["onInverseSurface"]as int? ?? 0xfff5f5f5),
